package com.ek.leetcode.bazinga.utils.reflection;
...
public class ReflectionTest {
    ...
    public void getMethodTest() throws Exception {
        ...
        Class cls = Class.forName("com.ek.utils.reflection.ReflectionTest");
        ...
        String returnStr = (String) method.invoke(cls.newInstance(), args);
